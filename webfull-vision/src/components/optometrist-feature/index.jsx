const OptometristFeature = () => (
  <div className="container px-4 sm:px-8 lg:px-48 pt-10 sm:pt-20">
    <div className="flex flex-col-reverse lg:flex-row">
      <div className="w-full lg:w-1/2">
        <img
          src="/img/optometrist-feature.png"
          alt="doctor team"
          className="w-full h-auto object-cover"
        />
      </div>
      <div className="px-4 pb-5 sm:px-6 lg:px-8 w-full lg:w-1/2 flex flex-col">
...
export default OptometristFeature;
