        ...
        <div className="relative pl-3 bg-[#15568E] w-[400px] h-80">
            <div className="pt-5 float-left">
                ...
                <p className="text-white text-sm py-4">
                    Our Vide range of Lenses and frames <br /> help you to chose best suitable <br /> items for you.
                </p>
                <div className="">
                    <ul>
                        <li className="text-white"><span>&#10004;</span> Latest to Fasion </li>
                        <li className="text-white"><span>&#10004;</span> High Quality and Branded</li>
                        <li className="text-white"><span>&#10004;</span> Best for your Eyes</li>
                    </ul>
                </div>
