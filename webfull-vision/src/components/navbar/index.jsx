...
const NavBar = () => {
  ...
  return (
    <div className="hidden md:block bg-[#CE6021]">
      <div className="flex justify-between items-center px-48 p-2">
        <ul className="flex items-center space-x-4 list-none">{navBar}</ul>
        <ul className="flex items-center space-x-4 list-none">{social}</ul>
      </div>
    </div>
  );
};
